...
const correctionList: any[] = corrections as any[];

initDB();
initResolutionMemory();

async function run(invoice: any) {
...
storeResolution(
  correctionList[0].invoiceId,
  correctionList[0].vendor,
  correctionList[0].finalDecision
);
